                ...
                data.TripTypes.AddRange(new[]
{
            ...
            if (!data.Flights.Any())
            {
                ...
                {
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,11,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 1, Price = 200, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 7},
                ...
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,11,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 400, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 7},
                ...
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,11,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 700, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 6},
                ...
                new Flight{StartLocation = "Berlin", EndLocation ="Sofia", FlightDate = new DateTime(2024,11,21), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 240, ImageUrl = "../Images/LocationImages/Sofia.jpg", IsPublic = true, PlaneId = 7},
                ...
                new Flight{StartLocation = "Sofia", EndLocation = "Phuket", FlightDate = new DateTime(2024,11,15), FlightDuration = new TimeSpan(10,30,0), Transfer = 0, Price = 5000, ImageUrl = "../Images/LocationImages/Phuket.jpg", IsPublic = true, PlaneId = 2},
                new Flight{StartLocation = "Phuket", EndLocation = "Sofia", FlightDate = new DateTime(2024,11,22), FlightDuration = new TimeSpan(10,30,0), Transfer = 0, Price = 5000, ImageUrl = "../Images/LocationImages/Sofia.jpg", IsPublic = true, PlaneId = 2},
                ...
                new Flight{StartLocation = "Sofia", EndLocation = "Burgas", FlightDate = new DateTime(2024,11,15), FlightDuration = new TimeSpan(0,40,0), Transfer = 0, Price = 100, ImageUrl = "../Images/LocationImages/Burgas.jpg", IsPublic = true, PlaneId = 9},
                new Flight{StartLocation = "Burgas", EndLocation = "Sofia", FlightDate = new DateTime(2024,11,25), FlightDuration = new TimeSpan(0,40,0), Transfer = 0, Price = 750, ImageUrl = "../Images/LocationImages/Sofia.jpg", IsPublic = true, PlaneId = 3},
                ...
                new Flight{StartLocation = "Sofia", EndLocation = "NewYork", FlightDate = new DateTime(2024,11,15), FlightDuration = new TimeSpan(12,30,0), Transfer = 1, Price = 1800, ImageUrl = "../Images/LocationImages/NewYork.jpg", IsPublic = true, PlaneId = 6},
                ...
                new Flight{StartLocation = "Sofia", EndLocation = "London", FlightDate = new DateTime(2024,11,20), FlightDuration = new TimeSpan(3,00,0), Transfer = 0, Price = 250, ImageUrl = "../Images/LocationImages/London.jpg", IsPublic = true, PlaneId = 3},
                ...
                new Flight{StartLocation = "London", EndLocation ="NewYork", FlightDate = new DateTime(2024,11,17), FlightDuration = new TimeSpan(6,00,0), Transfer = 0, Price = 6000, ImageUrl = "../Images/LocationImages/NewYork.jpg", IsPublic = true, PlaneId = 5},
                new Flight{StartLocation = "NewYork", EndLocation ="London", FlightDate = new DateTime(2024,11,17), FlightDuration = new TimeSpan(6,00,0), Transfer = 0, Price = 5500, ImageUrl = "../Images/LocationImages/London.jpg", IsPublic = true, PlaneId = 5},
            });
            }
