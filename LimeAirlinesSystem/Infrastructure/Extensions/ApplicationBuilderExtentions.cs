                ...
                data.TripTypes.AddRange(new[]
{
            ...
            if (!data.Flights.Any())
            {
                ...
                {
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,07,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 200, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 7},
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,07,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 300, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 7},
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,07,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 400, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 7},
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,07,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 500, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 7},
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,07,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 600, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 7},
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,07,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 700, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 7},
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,07,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 800, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 7},
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,07,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 900, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 7},
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,07,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 1000, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 7},
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2024,07,15), FlightDuration = new TimeSpan(3,30,0), Transfer = 0, Price = 400, ImageUrl = "../Images/LocationImages/Berlin.jpg", IsPublic = true, PlaneId = 1},
                new Flight{StartLocation = "Berlin", EndLocation ="Sofia", FlightDate = new DateTime(2024,08,17), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 240, ImageUrl = "../Images/LocationImages/Sofia.jpg", IsPublic = true, PlaneId = 8},
                new Flight{StartLocation = "Sofia", EndLocation = "Phuket", FlightDate = new DateTime(2024,08,12), FlightDuration = new TimeSpan(10,30,0), Transfer = 1, Price = 1900, ImageUrl = "../Images/LocationImages/Phuket.jpg", IsPublic = true, PlaneId = 11},
                new Flight{StartLocation = "Sofia", EndLocation = "Burgas", FlightDate = new DateTime(2024,07,25), FlightDuration = new TimeSpan(0,40,0), Transfer = 0, Price = 50, ImageUrl = "../Images/LocationImages/Burgas.jpg", IsPublic = true, PlaneId = 3},
                new Flight{StartLocation = "Burgas", EndLocation = "Sofia", FlightDate = new DateTime(2024,06,24), FlightDuration = new TimeSpan(1,0,0), Transfer = 0, Price = 80, ImageUrl = "../Images/LocationImages/Sofia.jpg", IsPublic = true, PlaneId = 4},
                new Flight{StartLocation = "Burgas", EndLocation = "Sofia", FlightDate = new DateTime(2024,07,30), FlightDuration = new TimeSpan(1,10,0), Transfer = 0, Price = 120, ImageUrl = "../Images/LocationImages/Sofia.jpg", IsPublic = true, PlaneId = 3},
            });
            }
            ...
            if (!data.FAQs.Any())
            {
                ...
                {
                new FAQ{ Title = "Baggage", ImageUrl = "../Images/FAQImages/luggage.jpg", IsPublic = true, 
