                ...
                data.TripTypes.AddRange(new[]
{
            ...
            if (!data.Planes.Any())
            {
                ...
                new Plane{Brand = "TBM", Model = "940", NumberOfSeats = 6, ImageUrl = "https://www.daher.com/app/uploads/2019/05/TBM-Notre-offre-TBM-940.jpg", Year = 2019, CategoryId = 2},
                ...
                new Plane{Brand = "Airbus", Model = "A380", NumberOfSeats = 644, ImageUrl = "http://www.infotourism.net/documents/43834_airbusa.jpg", Year = 2020, CategoryId = 5}
            });
            }
            ...
            if (!data.Flights.Any())
            {
                ...
                {
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2023,03,12), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 200, ImageUrl = "https://www.germany.travel/media/redaktion/content/bundeslaender/berlin/Berlin_Brandenburger_Tor_im_Sonnenuntergang_Leitmotiv_German_Summer_Cities.jpg", IsPublic = true, PlaneId = 7},
                new Flight{StartLocation = "Sofia", EndLocation = "Berlin", FlightDate = new DateTime(2023,03,15), FlightDuration = new TimeSpan(3,30,0), Transfer = 0, Price = 400, ImageUrl = "https://www.germany.travel/media/redaktion/content/bundeslaender/berlin/Berlin_Brandenburger_Tor_im_Sonnenuntergang_Leitmotiv_German_Summer_Cities.jpg", IsPublic = true, PlaneId = 1},
                new Flight{StartLocation = "Berlin", EndLocation ="Sofia", FlightDate = new DateTime(2023,03,17), FlightDuration = new TimeSpan(2,10,0), Transfer = 0, Price = 240, ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Cathedral_Saint_Alexander_Nevsky_%2823997168458%29.jpg/800px-Cathedral_Saint_Alexander_Nevsky_%2823997168458%29.jpg", IsPublic = true, PlaneId = 8},
